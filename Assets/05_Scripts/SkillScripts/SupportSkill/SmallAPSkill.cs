...
public class SmallAPSkill : ISkill
{
    ...
    public SmallAPSkill(PlayerManager playerManager)
    {
    ...
    public void Execute()
    {
        EventMessageManager.Instance.MessageQueueRegistry(new EventContainer() { eventType = ContextType.Battle, Context = "작은 AP 물약을 사용합니다." });
