...
public class MagicianCombo02 : ISkill
{
    ...
    public MagicianCombo02(PlayerManager playerManager)
    {
    ...
    public void Execute()
    {
        ...
        if (isPlayer)
        {
            ...
            playerManager.status.UseAP(4);

        }
        EventMessageManager.Instance.MessageQueueRegistry(new EventContainer() { eventType = ContextType.Battle, Context = "운석 소환 스킬을 사용합니다." });
