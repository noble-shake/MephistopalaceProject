...
public class MagicianSpecial: ISkill
{
    ...
    public MagicianSpecial(PlayerManager playerManager)
    {
    ...
    public void Execute()
    {
        ...
        EventMessageManager.Instance.MessageQueueRegistry(new EventContainer() { eventType = ContextType.Battle, Context = "강력한 위성 충돌 스킬을 사용합니다." });
