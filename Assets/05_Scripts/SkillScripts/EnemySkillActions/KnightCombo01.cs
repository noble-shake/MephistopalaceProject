...
public class KnightCombo01 : ISkill
{
    ...
    public KnightCombo01(EnemyManager enemyManager, int _qte)
    {
    ...
    public void Execute()
    {
        EventMessageManager.Instance.MessageQueueRegistry(new EventContainer() { eventType = ContextType.Battle, Context = "어둠 기사가 연속 콤보를 수행합니다." });
    ...
    {
        enemyManager.animator.animator.Play("BattleCombo01");
        yield return null;
    }
