...
public class DragonCombo02 : ISkill
{
    ...
    public DragonCombo02(EnemyManager enemyManager, int _qte)
    {
    ...
    public void Execute()
    {
        EventMessageManager.Instance.MessageQueueRegistry(new EventContainer() { eventType = ContextType.Battle, Context = "던전의 주인이 휩쓸기를 수행합니다." });
